...
from . import views
from board.views import base_views, question_views, answer_viwes, vote_views, comment_views
...
urlpatterns = [
    ...
    path('answer/create/<int:question_id>/', answer_viwes.answer_create, name='answer_create'),
    # 질문 수정
    path('question/modify/<int:question_id>/', question_views.question_modify, name='question_modify'),
    # 답변 수정
    path('answer/modify/<int:answer_id>/', answer_viwes.answer_modify, name='answer_modify'),
    # 질문 삭제
    path('question/delete/<int:question_id>/', question_views.question_delete, name='question_delete'),
    # 답변 삭제
    path('answer/delete/<int:answer_id>/', answer_viwes.answer_delete, name='answer_delete'),
    # 질문 추천
